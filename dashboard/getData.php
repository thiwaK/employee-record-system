<?php
    ...
    if($usertype == "superuser"){
        //get number of rows
        $queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM employee INNER JOIN divisions_of_nrmc ON employee.unit=divisions_of_nrmc.unit_name
            INNER JOIN users ON divisions_of_nrmc.unit_name=users.userunit ".$whereSQL.$orderSQL);
        $resultNum = $queryNum->fetch_assoc();
        $rowCount = $resultNum['postNum'];
        ...
        //get rows
        $queryNum = mysqli_query($db_connect, "SELECT * FROM employee INNER JOIN divisions_of_nrmc ON employee.unit=divisions_of_nrmc.unit_name
            INNER JOIN users ON divisions_of_nrmc.unit_name=users.userunit $whereSQL $orderSQL LIMIT $start, $limit");
        $queryNumcount = mysqli_num_rows($queryNum);
    }
    ...
    if($usertype == "superuser"){
     ...
     if($usertype == "superuser"){
        $queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM employee INNER JOIN divisions_of_nrmc ON employee.unit=units_of_nrmc.unit_name
INNER JOIN users ON units_of_nrmc.unit_name=users.userunit ".$whereSQL.$orderSQL);
        $resultNum = $queryNum->fetch_assoc();
        $rowCount = $resultNum['postNum'];
        ...
        //get rows
        $queryNum = mysqli_query($db_connect, "SELECT * FROM employee INNER JOIN units_of_nrmc ON employee.unit=units_of_nrmc.unit_name
INNER JOIN users ON units_of_nrmc.unit_name=users.userunit $whereSQL $orderSQL LIMIT $start, $limit");
        $queryNumcount = mysqli_num_rows($queryNum);
    }
    ...
    if($usertype == "superuser"){
        $queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM employee INNER JOIN units_of_nrmc ON employee.unit=units_of_nrmc.unit_name
            INNER JOIN users ON divisions_of_nrmc.unit_name=users.userunit $whereSQL $orderSQL");
        $resultNum = $queryNum->fetch_assoc();
        $rowCount = $resultNum['postNum'];
        ...
        //get rows
        $queryNum = mysqli_query($db_connect, "SELECT * FROM employee INNER JOIN divisions_of_nrmc ON employee.unit=divisions_of_nrmc.unit_name INNER JOIN users ON divisions_of_nrmc.unit_name=users.userunit $whereSQL $orderSQL LIMIT $start, $limit");
        $queryNumcount = mysqli_num_rows($queryNum);
    }
