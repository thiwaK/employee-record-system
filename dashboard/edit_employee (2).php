		...
		<div class="container">
			<div class="wrapper add_employee clearfix">
				...
				<form id="editemployee" class="clearfix" method="" action="">
					...
					<div class="input-box input-small right">
						...
						<select class="inputField unit" name="unit">
							...
							<?php
								...
								$sql = "SELECT DISTINCT unit_name FROM units_of_etc WHERE 1;";
					...
					<div class="input-box input-small left">
						<label for="joined_etc">Date employed ETC</label><br>
						<input type="text" class="datepicker inputField joined_etc" name="joined_etc" value="<?php echo $joined_etc ?>">
						<div class="error ddateemployedetcerror"></div>
					</div>
					<div class="input-box input-small right">
