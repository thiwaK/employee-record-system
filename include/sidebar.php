        ...
        <ul class="nav nav-pills flex-column pt-2 pl-3">
            ...
            <li class="nav-item">
                ...
                <ul class="nav collapse ml-4" id="employeesSubMenu" style="margin-top: 0;">
                    ...
                    <!-- <li class="nav-item submenu"><a class="nav-link" href="../dashboard/report_print.php">Employee Reports</a></li> -->
            ...
            <!-- <li class="nav-item">
                ...
                <ul class="nav collapse ml-4" id="preferencesSubMenu" style="margin-top: 0;">
                    <li class="nav-item submenu"><a class="nav-link" href="../backup/sys_backup.php">Backup Database</a></li>
                    <li class="nav-item submenu"><a class="nav-link" href="../dashboard/settings.php">Settings</a></li>
				</ul>
            </li> -->
